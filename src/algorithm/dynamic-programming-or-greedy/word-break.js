...
// 看 s[0..j−1] 组成的字符串 s1​（默认 j=0 时 s1为空串）和 s[j..i−1] 组成的字符串 s2 是否都合法，如果两个字符串均合法，那么按照定义 s1 和 s2
// ​拼接成的字符串也同样合法。由于计算到 dp[i] 时我们已经计算出了 dp[0..i−1] 的值，因此字符串 s1 是否合法可以直接由 dp[j] 得知，
...
var wordBreak = function(s, wordDict) {
  ...
  map = new Map()
  dp[0] = true
  wordDict.forEach(i => map.set(i, true))
...
// case1 输入：s = "leetcode", wordDict = ["leet", "code"] 预期：true
console.log(wordBreak('leetcode', ['leet', 'code']))

// case2 输入：s = "applepenapple", wordDict = ["apple", "pen"] 预期：true
console.log(wordBreak('applepenapple', ['apple', 'pen']))

// case3 输入：s = "catsandog", wordDict = ["cats", "dog", "sand", "and", "cat"] 预期：false
